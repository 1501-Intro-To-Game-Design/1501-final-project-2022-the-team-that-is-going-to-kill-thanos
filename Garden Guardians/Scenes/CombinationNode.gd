...
export (PackedScene) var mac_n_cheese
		...
		if towers[0].combinable == true and not (towers[0] == tower_to_combine):
			...
			if tower_to_combine.is_in_group("Tomato"):
				if towers[0].is_in_group("Potato"):
					...
					towers[0].plate.simple_make_tower(new_tower, 0, 0, -68, false)
					towers[0].queue_free()
					return true
				elif towers[0].is_in_group("Spaghetti"):
					new_tower = marinara_spaghetti
					towers[0].plate.simple_make_tower(new_tower, 0, 0, -20, false)
					towers[0].queue_free()
					...
					towers[0].plate.simple_make_tower(new_tower, 0, 0, -34, false)
					towers[0].queue_free()
					return true
				...
				if towers[0].is_in_group("Tomato"):
					...
					towers[0].plate.make_rib_plate(towers[0])
					towers[0].plate.simple_make_tower(new_tower, 0, 0, -28, false)
					towers[0].queue_free()
					return true
				elif towers[0].is_in_group("Spaghetti"):
					new_tower = gnocchi
					...
					towers[0].plate.simple_make_tower(new_tower, 0, 0, -22, false)
					towers[0].queue_free()
					return true
				...
				if towers[0].is_in_group("Tomato"):
					...
					towers[0].plate.make_rib_plate(tower_to_combine)
					towers[0].plate.simple_make_tower(new_tower, 0, 0, -33, false)
					towers[0].queue_free()
					return true
